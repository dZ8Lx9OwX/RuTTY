...
/* rutty: Session/Scripting panel */
	...
	ctrl_filesel(s, "Script filename:", 'f',
		 ...
		 dlg_stdfilesel_handler, I(offsetof(Config, script_filename)));

	ctrl_radiobuttons(s, NULL, 'e', 4, HELPCTX(no_help),
          dlg_stdradiobutton_handler,I(offsetof(Config,script_mode)),
          "Off", I(SCRIPT_STOP),
          "Replay", I(SCRIPT_PLAY),
          "Record", I(SCRIPT_RECORD),
          NULL);

	ctrl_editbox(s, "line delay (ms)", 'd', 40,HELPCTX(terminal_blink),
		 dlg_stdeditbox_handler, I(offsetof(Config,script_line_delay)), I(-1));

	ctrl_editbox(s, "character delay (ms)", 'z', 40, HELPCTX(no_help),
		 dlg_stdeditbox_handler, I(offsetof(Config,script_char_delay)), I(-1));
	
	ctrl_editbox(s, "start of condition/comment line", 'u', 40, HELPCTX(no_help),
	...
	ctrl_editbox(s, "halt on", 'v', 80, HELPCTX(no_help),
		 dlg_stdeditbox_handler, I(offsetof(Config,script_halton)),
		 I(sizeof(((Config *)0)->script_halton)));
              
	ctrl_checkbox(s, "wait for response from host", 'n', HELPCTX(no_help),
		  dlg_stdcheckbox_handler, I(offsetof(Config,script_enable)));
	ctrl_checkbox(s, "except for first command", 'm', HELPCTX(no_help),
		  dlg_stdcheckbox_handler, I(offsetof(Config,script_except)));
	ctrl_checkbox(s, "use conditions from file", 'n', HELPCTX(no_help),
		  dlg_stdcheckbox_handler, I(offsetof(Config,script_cond_use)));
	
	ctrl_editbox(s, "timeout (sec)", 'r', 40,
		 HELPCTX(terminal_answerback),
		 dlg_stdeditbox_handler, I(offsetof(Config,script_timeout)),I(-1));
	ctrl_editbox(s, "wait for", 't', 80, HELPCTX(no_help),
		 dlg_stdeditbox_handler, I(offsetof(Config,script_waitfor)),
		 I(sizeof(((Config *)0)->script_waitfor)));
#endif  /* rutty */
