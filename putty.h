...
/* rutty: */	
   ...
   int script_mode;  /* stop, play or record */
   int script_line_delay;  /* in ms */
   int script_char_delay;  /* in ms */
   char script_cond_line[16];
   int script_cond_use;  /* use conditions from script file */
   int script_crlf;  /* cr/lf translation */
   int script_enable;  /* wait for host response */
   int script_except;  /* except firstline */
   int script_timeout;  /* sec */
   char script_waitfor[128];
   char script_halton[128];
#endif  /* rutty */
